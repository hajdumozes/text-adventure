...
public class Berserk extends Skill {
    ...
    public void useSkill(Character target) {
        ...
        getOwner().addToEffects(new AttributeEffect(new AttackBonus(), "increased attack of Berserk", 5, 3));
        getOwner().getArmorClass().setCurrentValue(getOwner().getArmorClassValue() - 5);
        getOwner().addToEffects(new AttributeEffect(new ArmorClass(), "decreased defense of Berserk", -5, 3));
        decreaseSkillUsage();
    }
}
